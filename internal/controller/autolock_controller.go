...
func (r *AutolockReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.reconcileMQTTDeployment(ctx, &autolock); err != nil {
		return ctrl.Result{}, err
	}

	if err := r.reconcileMQTTService(ctx, &autolock); err != nil {
		return ctrl.Result{}, err
	}
	...
	if err := r.reconcileWebappService(ctx, &autolock); err != nil {
		return ctrl.Result{}, err
	}
	...
	if err := r.reconcileAuthDBInitConfigMap(ctx, &autolock); err != nil {
		return ctrl.Result{}, err
	}

	if err := r.reconcileAuthDBService(ctx, &autolock); err != nil {
		return ctrl.Result{}, err
	}
